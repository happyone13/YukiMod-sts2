...
- 初始遗物：`YukiStarterRelic`，战斗开始时 `凝聚1`
...
- 当前版本 `104` 的原游戏解包参考目录为 `E:\DATA\GODOT\MyMod\sts104`
...
- Godot 路径是否仍然有效
- 资源导出是否跟代码版本一致
- 如需核对原版能力、遗物、卡牌、动作或 Hook 行为，应优先在 `E:\DATA\GODOT\MyMod\sts104` 中查对应实现

## 6. 当前已知空缺与风险

- 起始卡组与起始遗物已经有第一版闭环，但月影、黑云、灵感三条主机制仍未完全收口
